...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Shaheem Finance" },
      { property: "og:description", content: "Fast, offline-first personal finance tracker. Track income, expenses, budgets and reports." },
